...
<div class="plan-container">
    ...
    <div class="plan-div">
        <!-- Koyel -->
        <div class="planTextedit" id="planDiv6">
            <div style="display: inline-block"><a href="Edit-user?sec=edit"><button class="editBtn" type="submit">Edit</button></a></div>
    ...
    <div class="plan-div">
        <!-- Souvik Da -->
        <div class="planTextedit" id="planDiv7">
            <div style="display: inline-block"><a href="Edit-user?sec=edit"><button class="editBtn" type="submit">Edit</button></a></div>
    ...
    <div class="plan-div">
        <!-- Piu -->
        <div class="planTextedit" id="planDiv8">
            <div style="display: inline-block"><a href="Edit-user?sec=edit"><button class="editBtn" type="submit">Edit</button></a></div>
    ...
    <div class="plan-div">
        <!-- guest 1 -->
        <div class="planTextedit" id="planDiv9">
            <div style="display: inline-block"><a href="Edit-user?sec=edit"><button class="editBtn" type="submit">Edit</button></a></div>
    ...
    <div class="plan-div">
        <!-- guest 2 -->
        <div class="planTextedit" id="planDiv10">
            <div style="display: inline-block"><a href="Edit-user?sec=edit"><button class="editBtn" type="submit">Edit</button></a></div>
